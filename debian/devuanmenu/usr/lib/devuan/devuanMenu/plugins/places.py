...
class pluginclass( object ):
    ...
    def __init__( self, devuanMenuWin, toggleButton, de ):
        ...
        # Settings
        self.settings = EasyGSettings("com.devuan.devuanmenu.plugins.places")
    ...
    def do_standard_places( self ):
        ...
        if ( self.showcomputer == True ):
            ...
            self.devuanMenuWin.setTooltip( Button1, _("Browse all local and remote disks and folders accessible from this computer") )
        ...
        if ( self.showhomefolder == True ):
            ...
            self.devuanMenuWin.setTooltip( Button2, _("Open your personal folder") )
        ...
        if ( self.shownetwork == True and self.de == "mate"):
            ...
            self.devuanMenuWin.setTooltip( Button3, _("Browse bookmarked and local network locations") )
        ...
        if ( self.showdesktop == True ):
            ...
            self.devuanMenuWin.setTooltip( Button4, _("Browse items placed on the desktop") )
        ...
        if ( self.showtrash == True ):
            ...
            self.devuanMenuWin.setTooltip( self.trashButton, _("Browse deleted files") )
