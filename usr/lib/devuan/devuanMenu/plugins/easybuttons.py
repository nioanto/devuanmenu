...
class IconManager(GObject.GObject):
    ...
    def __init__( self ):
        ...
        self.iconDir = os.path.join(configDir, "devuanmenu")
...
class ApplicationLauncher( easyButton ):
    ...
    def uninstall (self, *args ):
        Execute("gksu /usr/lib/devuan/common/devuan-remove-application.py " + self.desktopFile)
    ...
    def addToFavourites( self ):
        favouritesDir = os.path.join( os.path.expanduser("~"), ".devuan", "devuanMenu", "applications" );
