...
class pluginclass( object ):
    ...
    def __init__( self, devuanMenuWin, toggleButton, de ):
        ...
        # Gconf stuff
        self.settings = EasyGSettings( "com.devuan.devuanmenu.plugins.system_management" )
    ...
    def do_standard_items( self ):
        ...
        if ( self.showSoftwareManager == True ):
            if os.path.exists("/usr/bin/mintinstall"):
                ...
                self.devuanMenuWin.setTooltip( Button1, _("Browse and install available software") )
        ...
        if ( self.showPackageManager == True ):
            ...
            self.devuanMenuWin.setTooltip( Button2, _("Install, remove and upgrade software packages") )
        ...
        if ( self.showControlCenter == True ):
            ...
            self.devuanMenuWin.setTooltip( Button3, _("Configure your system") )
        ...
        if ( self.showTerminal == True ):
            ...
            self.devuanMenuWin.setTooltip( Button4, _("Use the command line") )
        ...
        if self.de == "xfce":
            ...
            self.devuanMenuWin.setTooltip( Button6, _("Log out or switch user") )
        else:
            if ( self.showLockScreen == True ):
                ...
                self.devuanMenuWin.setTooltip( Button5, _("Requires password to unlock") )
            ...
            if ( self.showQuit == True ):
                ...
                self.devuanMenuWin.setTooltip( Button7, _("Shutdown, restart, suspend or hibernate") )
